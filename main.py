...
def start(message):
    ...
    if message.chat.type == "private":
        ...
        # В группе отправляем сообщение без кнопок
        bot.send_message(message.chat.id, "Добро пожаловать! Напишите мне в личные сообщения для доступа к функциям бота.")
...
# ВСЕ КНОПКИ МЕНЮ ОБРАБАТЫВАЮТСЯ ОТДЕЛЬНО И НЕ ПОПАДАЮТ В handle_all_messages
